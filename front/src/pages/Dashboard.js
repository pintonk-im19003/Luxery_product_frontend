        ...
        <div>
            ...
            <div className="profileContainer">
                <div className="informationSection">
                    ...
                    <div className='container'>
                        <button className="buttonito" onClick={ ()=> {navigate('/createitem')}}>CREATE A NEW PRODUCT</button>
                    </div>
                    ...
                    :
                    <div className='container'>
                        <Header text="When you bid on an items it will appear here" />
                    </div>
                    }
                    <div className='container'>
